...
<div class="nav-container">
   <div class="navbar">
      ...
      <div class="nav-menu">
         <div>
            <form class="search-form" action="search.php" method="POST" onclick="alert('Under Devlopment. Coming Soon!');">      
   ...
   <form class="mobile-form" action="login.php" method="POST">
      <div class="menu-mobile" id="men">         
         ...
         <button onclick="alert('Under Devlopment. Coming Soon!');"  type="submit" class="mob-search-btn transp">Search</button> 
